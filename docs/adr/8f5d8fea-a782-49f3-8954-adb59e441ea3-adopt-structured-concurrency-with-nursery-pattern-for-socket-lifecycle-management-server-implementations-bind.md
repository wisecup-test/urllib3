...
1. MUST: Server implementations MUST bind to both IPv4 and IPv6 address families when host is localhost to avoid connection delays from sequential address family attempts

## Policy Block

- MUST Server implementations MUST bind to both IPv4 and IPv6 address families when host is localhost to avoid connection delays from sequential address family attempts
