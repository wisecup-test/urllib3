...
1. MUST: Connection pool tests MUST track connection object identity through data access patterns that add connections to observable collections

## Policy Block

- MUST Connection pool tests MUST track connection object identity through data access patterns that add connections to observable collections
