...
1. MUST: Socket binding MUST use socket.bind() with explicit (host, port) tuple parameters

## Policy Block

- MUST Socket binding MUST use socket.bind() with explicit (host, port) tuple parameters
