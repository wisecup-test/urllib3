...
1. SHOULD: Logging statements SHOULD be placed at integration boundaries where external clients are accessed or internal state transitions occur

## Policy Block

- SHOULD Logging statements SHOULD be placed at integration boundaries where external clients are accessed or internal state transitions occur
