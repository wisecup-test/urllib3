...
1. MAY: Server implementations MAY separate secure_sockets and insecure_sockets based on SSL configuration

## Policy Block

- MAY Server implementations MAY separate secure_sockets and insecure_sockets based on SSL configuration
