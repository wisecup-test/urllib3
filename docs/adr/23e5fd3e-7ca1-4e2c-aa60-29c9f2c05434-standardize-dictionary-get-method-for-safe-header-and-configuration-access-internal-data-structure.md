...
1. SHOULD: Internal data structure access (self.headers.get, kwargs.get) SHOULD prefer .get() method when the key may legitimately be absent

## Policy Block

- SHOULD Internal data structure access (self.headers.get, kwargs.get) SHOULD prefer .get() method when the key may legitimately be absent
