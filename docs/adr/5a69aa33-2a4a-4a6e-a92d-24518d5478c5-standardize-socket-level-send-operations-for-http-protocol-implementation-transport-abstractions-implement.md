...
1. SHOULD: Transport abstractions SHOULD implement common interface contracts (send, recv, close, fileno) to enable polymorphic usage across socket, SSL, and custom transports

## Policy Block

- SHOULD Transport abstractions SHOULD implement common interface contracts (send, recv, close, fileno) to enable polymorphic usage across socket, SSL, and custom transports
