# Standardize Socket-Level Send Operations for HTTP Protocol Implementation: Socket Level Send
...
1. MUST: Socket-level send operations MUST handle partial writes by iterating until all data is transmitted or an error occurs

## Policy Block

- MUST Socket-level send operations MUST handle partial writes by iterating until all data is transmitted or an error occurs
