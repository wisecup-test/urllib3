...
1. MAY: Test modules MAY include specialized test infrastructure such as mock servers, socket handlers, and certificate authorities (trustme.CA) to simulate external dependencies

## Policy Block

- MAY Test modules MAY include specialized test infrastructure such as mock servers, socket handlers, and certificate authorities (trustme.CA) to simulate external dependencies
