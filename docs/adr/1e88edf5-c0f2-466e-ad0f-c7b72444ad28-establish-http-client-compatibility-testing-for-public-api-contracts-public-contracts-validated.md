...
1. MUST: All public API contracts MUST be validated through compatibility tests that exercise multiple HTTP client implementations (urllib, urllib3, http.cookiejar)

## Policy Block

- MUST All public API contracts MUST be validated through compatibility tests that exercise multiple HTTP client implementations (urllib, urllib3, http.cookiejar)
