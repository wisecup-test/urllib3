...
1. MUST: HTTP/2 connection implementations MUST coordinate send operations with stream multiplexing to prevent frame interleaving corruption

## Policy Block

- MUST HTTP/2 connection implementations MUST coordinate send operations with stream multiplexing to prevent frame interleaving corruption
