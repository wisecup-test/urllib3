...
1. MUST: Socket-based authentication servers MUST use structured concurrency primitives (nursery.start or equivalent) to coordinate server lifecycle with shutdown events

## Policy Block

- MUST Socket-based authentication servers MUST use structured concurrency primitives (nursery.start or equivalent) to coordinate server lifecycle with shutdown events
