...
1. MAY: Modules MAY configure additional logging handlers or formatters specific to their testing requirements

## Policy Block

- MAY Modules MAY configure additional logging handlers or formatters specific to their testing requirements
