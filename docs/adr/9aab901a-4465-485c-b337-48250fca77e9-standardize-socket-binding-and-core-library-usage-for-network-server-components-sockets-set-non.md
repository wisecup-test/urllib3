...
1. SHOULD: Sockets SHOULD be set to non-blocking mode using sock.setblocking(False) for asynchronous server implementations

## Policy Block

- SHOULD Sockets SHOULD be set to non-blocking mode using sock.setblocking(False) for asynchronous server implementations
