...
1. SHOULD: Certificate dictionary access (cert.get) SHOULD use .get() method when accessing optional fields like subjectAltName and subject

## Policy Block

- SHOULD Certificate dictionary access (cert.get) SHOULD use .get() method when accessing optional fields like subjectAltName and subject
