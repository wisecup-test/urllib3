...
1. MUST: All public API contracts MUST be validated through dedicated test functions following the test_* naming convention and using pytest as the test framework

## Policy Block

- MUST All public API contracts MUST be validated through dedicated test functions following the test_* naming convention and using pytest as the test framework
