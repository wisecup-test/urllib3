...
1. SHOULD: Default values provided to .get() SHOULD be type-appropriate (empty string, False, None, 0, empty tuple) based on downstream usage

## Policy Block

- SHOULD Default values provided to .get() SHOULD be type-appropriate (empty string, False, None, 0, empty tuple) based on downstream usage
