...
1. MUST_NOT: Send operations MUST NOT assume complete transmission in a single call; implementations MUST NOT ignore return values indicating partial writes

## Policy Block

- MUST_NOT Send operations MUST NOT assume complete transmission in a single call; implementations MUST NOT ignore return values indicating partial writes
