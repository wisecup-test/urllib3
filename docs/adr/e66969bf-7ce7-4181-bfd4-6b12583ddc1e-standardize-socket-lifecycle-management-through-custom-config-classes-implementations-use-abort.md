...
1. MAY: Implementations MAY use abort controllers (js_abort_controller.abort.bind) for cancellation in browser-based environments

## Policy Block

- MAY Implementations MAY use abort controllers (js_abort_controller.abort.bind) for cancellation in browser-based environments
