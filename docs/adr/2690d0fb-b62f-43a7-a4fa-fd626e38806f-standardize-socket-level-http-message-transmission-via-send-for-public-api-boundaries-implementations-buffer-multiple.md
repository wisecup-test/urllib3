...
1. MAY: Implementations MAY buffer multiple send() calls internally but MUST preserve message ordering and boundary semantics

## Policy Block

- MAY Implementations MAY buffer multiple send() calls internally but MUST preserve message ordering and boundary semantics
