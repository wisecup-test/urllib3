...
1. MUST: Default values provided to .get() MUST match the semantic meaning of absence for that specific context (e.g., False for boolean flags, None for optional strings, 80 for default HTTP port)

## Policy Block

- MUST Default values provided to .get() MUST match the semantic meaning of absence for that specific context (e.g., False for boolean flags, None for optional strings, 80 for default HTTP port)
