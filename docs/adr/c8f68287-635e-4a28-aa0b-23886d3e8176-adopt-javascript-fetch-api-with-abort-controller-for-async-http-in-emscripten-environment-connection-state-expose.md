...
1. MUST: Connection state MUST expose is_closed, closed, close, readable, and writable properties to satisfy urllib3's public API contracts

## Policy Block

- MUST Connection state MUST expose is_closed, closed, close, readable, and writable properties to satisfy urllib3's public API contracts
