...
1. MUST: Socket binding operations MUST use sock.bind((host, port)) with explicit host and port parameters from the socket module

## Policy Block

- MUST Socket binding operations MUST use sock.bind((host, port)) with explicit host and port parameters from the socket module
