...
1. SHOULD: Connection pool tests SHOULD use fixtures that yield ServerConfig objects containing all necessary connection parameters

## Policy Block

- SHOULD Connection pool tests SHOULD use fixtures that yield ServerConfig objects containing all necessary connection parameters
