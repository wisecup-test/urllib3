...
1. SHOULD: Test functions SHOULD use descriptive names that clearly indicate the contract being validated (e.g., test_match_hostname_no_cert, test_redirects_disabled_for_pool_manager_with_0)

## Policy Block

- SHOULD Test functions SHOULD use descriptive names that clearly indicate the contract being validated (e.g., test_match_hostname_no_cert, test_redirects_disabled_for_pool_manager_with_0)
