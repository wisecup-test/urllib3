...
1. MUST: Service boundary definitions MUST be tested using mock and patch techniques to isolate external dependencies

## Policy Block

- MUST Service boundary definitions MUST be tested using mock and patch techniques to isolate external dependencies
