...
1. MUST: TLS version detection MUST populate version sets through socket-level inspection using _sock.version() calls

## Policy Block

- MUST TLS version detection MUST populate version sets through socket-level inspection using _sock.version() calls
