...
1. SHOULD: Asynchronous request operations SHOULD use abort controller patterns (js_abort_controller.abort.bind or equivalent) to enable cancellation propagation

## Policy Block

- SHOULD Asynchronous request operations SHOULD use abort controller patterns (js_abort_controller.abort.bind or equivalent) to enable cancellation propagation
