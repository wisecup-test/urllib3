...
1. MUST: Sockets MUST be set to non-blocking mode (setblocking(False)) before binding

## Policy Block

- MUST Sockets MUST be set to non-blocking mode (setblocking(False)) before binding
