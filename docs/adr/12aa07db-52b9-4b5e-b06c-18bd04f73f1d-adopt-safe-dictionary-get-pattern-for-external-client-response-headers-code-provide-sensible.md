...
1. SHOULD: Code SHOULD provide sensible defaults to .get() calls (e.g., port_by_scheme.get(scheme, 80)) rather than relying on None returns

## Policy Block

- SHOULD Code SHOULD provide sensible defaults to .get() calls (e.g., port_by_scheme.get(scheme, 80)) rather than relying on None returns
