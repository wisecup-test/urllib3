...
1. SHOULD: Logging statements at transmission boundaries SHOULD include contextual information such as data size, connection state, or protocol-specific metadata

## Policy Block

- SHOULD Logging statements at transmission boundaries SHOULD include contextual information such as data size, connection state, or protocol-specific metadata
