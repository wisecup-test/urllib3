...
1. MAY: Internal data structures with guaranteed key presence MAY use direct dictionary access

## Policy Block

- MAY Internal data structures with guaranteed key presence MAY use direct dictionary access
