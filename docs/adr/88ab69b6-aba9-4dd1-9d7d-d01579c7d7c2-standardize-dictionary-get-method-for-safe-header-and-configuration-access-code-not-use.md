...
1. MUST_NOT: Code MUST NOT use direct dictionary key access (dict[key]) when the key represents optional external data or configuration that may be absent

## Policy Block

- MUST_NOT Code MUST NOT use direct dictionary key access (dict[key]) when the key represents optional external data or configuration that may be absent
