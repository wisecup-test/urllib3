...
1. MUST_NOT: Public API methods (connect, putrequest, putheader, endheaders, send) MUST NOT bypass the send() primitive for message transmission

## Policy Block

- MUST_NOT Public API methods (connect, putrequest, putheader, endheaders, send) MUST NOT bypass the send() primitive for message transmission
