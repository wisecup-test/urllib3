...
1. MUST: Test modules MUST organize contract tests by functional domain (e.g., test_proxymanager.py, test_filepost.py, test_connectionpool.py, test_connection.py) with each module testing a cohesive set of related public interfaces

## Policy Block

- MUST Test modules MUST organize contract tests by functional domain (e.g., test_proxymanager.py, test_filepost.py, test_connectionpool.py, test_connection.py) with each module testing a cohesive set of related public interfaces
