...
1. SHOULD: Socket creation SHOULD support dual-stack IPv4/IPv6 binding using socket.getaddrinfo with AF_UNSPEC or AF_INET6 family detection

## Policy Block

- SHOULD Socket creation SHOULD support dual-stack IPv4/IPv6 binding using socket.getaddrinfo with AF_UNSPEC or AF_INET6 family detection
