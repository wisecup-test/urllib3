...
1. SHOULD: Sockets SHOULD configure TCP_NODELAY and SO_REUSEADDR options for optimal connection handling

## Policy Block

- SHOULD Sockets SHOULD configure TCP_NODELAY and SO_REUSEADDR options for optimal connection handling
