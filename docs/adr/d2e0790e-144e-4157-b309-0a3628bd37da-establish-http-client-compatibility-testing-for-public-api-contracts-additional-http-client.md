...
1. MAY: Additional HTTP client libraries MAY be added to the compatibility test suite as new dependencies are introduced

## Policy Block

- MAY Additional HTTP client libraries MAY be added to the compatibility test suite as new dependencies are introduced
