...
1. MUST: Server lifecycle fixtures MUST yield ServerConfig objects through context managers (run_server_in_thread, run_server_and_proxy_in_thread)

## Policy Block

- MUST Server lifecycle fixtures MUST yield ServerConfig objects through context managers (run_server_in_thread, run_server_and_proxy_in_thread)
