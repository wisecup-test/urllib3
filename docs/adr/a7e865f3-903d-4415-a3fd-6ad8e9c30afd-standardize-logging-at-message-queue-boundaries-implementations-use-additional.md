...
1. MAY: Implementations MAY use additional logging for pre-transmission validation or post-transmission confirmation

## Policy Block

- MAY Implementations MAY use additional logging for pre-transmission validation or post-transmission confirmation
