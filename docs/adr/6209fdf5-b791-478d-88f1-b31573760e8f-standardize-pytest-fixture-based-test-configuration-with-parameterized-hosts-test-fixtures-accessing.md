...
1. MUST: Test fixtures accessing network resources MUST use pytest.fixture with params to parameterize loopback hosts across localhost, 127.0.0.1, and ::1

## Policy Block

- MUST Test fixtures accessing network resources MUST use pytest.fixture with params to parameterize loopback hosts across localhost, 127.0.0.1, and ::1
