...
1. SHOULD: Test assertions SHOULD handle None returns from .get() calls explicitly to distinguish between missing headers and incorrect values

## Policy Block

- SHOULD Test assertions SHOULD handle None returns from .get() calls explicitly to distinguish between missing headers and incorrect values
