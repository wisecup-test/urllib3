...
1. MAY: Server configurations MAY use port 0 to request automatic port allocation from the operating system, then extract the assigned port via sock.getsockname()[1]

## Policy Block

- MAY Server configurations MAY use port 0 to request automatic port allocation from the operating system, then extract the assigned port via sock.getsockname()[1]
