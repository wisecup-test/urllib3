...
1. MUST: Parameterized fixtures MUST be used to test data access patterns across multiple protocol variants (IPv4, IPv6, loopback addresses)

## Policy Block

- MUST Parameterized fixtures MUST be used to test data access patterns across multiple protocol variants (IPv4, IPv6, loopback addresses)
