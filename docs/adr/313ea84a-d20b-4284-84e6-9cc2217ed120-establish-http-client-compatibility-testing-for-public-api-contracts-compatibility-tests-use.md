...
1. SHOULD: Compatibility tests SHOULD use pytest as the test framework for consistency with existing test infrastructure

## Policy Block

- SHOULD Compatibility tests SHOULD use pytest as the test framework for consistency with existing test infrastructure
