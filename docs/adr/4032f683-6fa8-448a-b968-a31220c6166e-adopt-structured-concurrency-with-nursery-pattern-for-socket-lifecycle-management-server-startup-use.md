...
1. SHOULD: Server startup SHOULD use functools.partial to bind configuration and shutdown triggers before passing to nursery.start

## Policy Block

- SHOULD Server startup SHOULD use functools.partial to bind configuration and shutdown triggers before passing to nursery.start
