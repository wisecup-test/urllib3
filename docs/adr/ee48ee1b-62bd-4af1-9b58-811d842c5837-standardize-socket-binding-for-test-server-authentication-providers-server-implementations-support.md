...
1. MUST: Server implementations MUST support port 0 allocation to obtain random available ports

## Policy Block

- MUST Server implementations MUST support port 0 allocation to obtain random available ports
