...
1. MAY: Tests MAY skip execution when required network capabilities (e.g., IPv6) are unavailable on the test host

## Policy Block

- MAY Tests MAY skip execution when required network capabilities (e.g., IPv6) are unavailable on the test host
