...
1. MUST: Request cancellation MUST be implemented using JavaScript AbortController bound to abort handlers (js_abort_controller.abort.bind)

## Policy Block

- MUST Request cancellation MUST be implemented using JavaScript AbortController bound to abort handlers (js_abort_controller.abort.bind)
