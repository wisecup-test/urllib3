...
1. MUST: Socket creation MUST handle both IPv4 and IPv6 address families using socket.getaddrinfo() with socket.AF_UNSPEC or explicit family selection

## Policy Block

- MUST Socket creation MUST handle both IPv4 and IPv6 address families using socket.getaddrinfo() with socket.AF_UNSPEC or explicit family selection
