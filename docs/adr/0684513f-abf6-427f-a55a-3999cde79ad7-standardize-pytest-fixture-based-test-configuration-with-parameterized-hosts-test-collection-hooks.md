...
1. SHOULD: Test collection hooks SHOULD implement pytest_addoption and pytest_collection_modifyitems to establish public configuration contracts

## Policy Block

- SHOULD Test collection hooks SHOULD implement pytest_addoption and pytest_collection_modifyitems to establish public configuration contracts
