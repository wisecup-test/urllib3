...
1. MUST: Modules MUST import both 'logging' and use 'getLogger' to obtain logger instances

## Policy Block

- MUST Modules MUST import both 'logging' and use 'getLogger' to obtain logger instances
