...
1. MUST: HTTP protocol version compatibility (HTTP/2) MUST be verified through dedicated test functions (test_h2_version_check)

## Policy Block

- MUST HTTP protocol version compatibility (HTTP/2) MUST be verified through dedicated test functions (test_h2_version_check)
