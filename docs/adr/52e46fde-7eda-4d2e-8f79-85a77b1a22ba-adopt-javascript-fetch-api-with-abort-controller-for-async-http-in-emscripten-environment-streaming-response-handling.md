...
1. SHOULD: Streaming response handling SHOULD use wait_for_streaming_ready to coordinate asynchronous fetch completion with synchronous Python code expectations

## Policy Block

- SHOULD Streaming response handling SHOULD use wait_for_streaming_ready to coordinate asynchronous fetch completion with synchronous Python code expectations
