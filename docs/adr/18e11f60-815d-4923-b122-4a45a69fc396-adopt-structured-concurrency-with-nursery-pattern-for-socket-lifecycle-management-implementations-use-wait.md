...
1. MAY: Implementations MAY use wait_for_streaming_ready patterns to coordinate streaming request initialization with server readiness

## Policy Block

- MAY Implementations MAY use wait_for_streaming_ready patterns to coordinate streaming request initialization with server readiness
