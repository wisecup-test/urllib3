...
1. MUST: All test modules MUST use pytest as the primary test framework and follow pytest discovery conventions (test_*.py files, test_* function names)

## Policy Block

- MUST All test modules MUST use pytest as the primary test framework and follow pytest discovery conventions (test_*.py files, test_* function names)
