...
1. SHOULD: Platform-specific or optional dependency tests SHOULD use pytest.skip() to conditionally skip tests when requirements are not met

## Policy Block

- SHOULD Platform-specific or optional dependency tests SHOULD use pytest.skip() to conditionally skip tests when requirements are not met
