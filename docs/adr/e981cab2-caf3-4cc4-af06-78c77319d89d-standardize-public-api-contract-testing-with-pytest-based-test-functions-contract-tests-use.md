...
1. MAY: Contract tests MAY use parameterized fixtures (@pytest.fixture(params=...)) to validate behavior across multiple input variations or configuration scenarios

## Policy Block

- MAY Contract tests MAY use parameterized fixtures (@pytest.fixture(params=...)) to validate behavior across multiple input variations or configuration scenarios
