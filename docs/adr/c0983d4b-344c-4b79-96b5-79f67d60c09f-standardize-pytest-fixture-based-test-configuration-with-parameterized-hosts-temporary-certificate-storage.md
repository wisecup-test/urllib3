...
1. SHOULD: Temporary certificate storage SHOULD use pytest.TempPathFactory.mktemp() for isolated test execution

## Policy Block

- SHOULD Temporary certificate storage SHOULD use pytest.TempPathFactory.mktemp() for isolated test execution
