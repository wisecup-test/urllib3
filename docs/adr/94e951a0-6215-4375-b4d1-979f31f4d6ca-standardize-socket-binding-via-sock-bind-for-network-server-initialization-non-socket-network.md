...
1. MUST: Non-socket network primitives (e.g., JavaScript fetch APIs in Emscripten contexts) MUST use framework-appropriate binding mechanisms such as abort_controller.abort.bind()

## Policy Block

- MUST Non-socket network primitives (e.g., JavaScript fetch APIs in Emscripten contexts) MUST use framework-appropriate binding mechanisms such as abort_controller.abort.bind()
