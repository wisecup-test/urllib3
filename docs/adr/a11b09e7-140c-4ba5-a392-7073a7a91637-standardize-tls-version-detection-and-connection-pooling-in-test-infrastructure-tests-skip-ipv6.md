...
1. MAY: Tests MAY skip IPv6 scenarios when HAS_IPV6 flag indicates platform lacks IPv6 support

## Policy Block

- MAY Tests MAY skip IPv6 scenarios when HAS_IPV6 flag indicates platform lacks IPv6 support
