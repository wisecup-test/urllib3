...
1. MAY: Tests MAY use unittest.mock for mocking when needed, as pytest is compatible with unittest-style assertions

## Policy Block

- MAY Tests MAY use unittest.mock for mocking when needed, as pytest is compatible with unittest-style assertions
