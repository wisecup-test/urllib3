...
1. MAY: Browser-based networking components MAY use JavaScript interop with abort controllers bound via js_abort_controller.abort.bind()

## Policy Block

- MAY Browser-based networking components MAY use JavaScript interop with abort controllers bound via js_abort_controller.abort.bind()
