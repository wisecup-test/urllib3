...
1. MUST: Fixtures generating TLS certificates MUST coordinate with parameterized loopback_host values using trustme.CA.issue_cert()

## Policy Block

- MUST Fixtures generating TLS certificates MUST coordinate with parameterized loopback_host values using trustme.CA.issue_cert()
