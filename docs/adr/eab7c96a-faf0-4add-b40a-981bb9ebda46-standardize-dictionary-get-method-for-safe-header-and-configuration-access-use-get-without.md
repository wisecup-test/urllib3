...
1. MAY: APIs MAY use .get() without a default argument when None is the appropriate semantic value for missing keys

## Policy Block

- MAY APIs MAY use .get() without a default argument when None is the appropriate semantic value for missing keys
