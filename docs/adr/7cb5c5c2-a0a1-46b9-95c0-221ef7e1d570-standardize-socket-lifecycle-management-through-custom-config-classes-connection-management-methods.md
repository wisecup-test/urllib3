...
1. SHOULD: Connection management methods (connect, start_forward, absolute_uri) SHOULD be exposed as public contracts for proxy and forwarding implementations

## Policy Block

- SHOULD Connection management methods (connect, start_forward, absolute_uri) SHOULD be exposed as public contracts for proxy and forwarding implementations
