...
1. MUST: HTTP response construction in test infrastructure MUST use sock.send() with complete HTTP/1.1 formatted responses including status line, headers, and body

## Policy Block

- MUST HTTP response construction in test infrastructure MUST use sock.send() with complete HTTP/1.1 formatted responses including status line, headers, and body
