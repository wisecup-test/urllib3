...
1. SHOULD: Server lifecycle management SHOULD use context managers (run_server_in_thread) to guarantee resource cleanup

## Policy Block

- SHOULD Server lifecycle management SHOULD use context managers (run_server_in_thread) to guarantee resource cleanup
