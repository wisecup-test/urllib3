...
1. MUST_NOT: Modules MUST NOT use hardcoded logger names or shared logger instances across unrelated modules

## Policy Block

- MUST_NOT Modules MUST NOT use hardcoded logger names or shared logger instances across unrelated modules
