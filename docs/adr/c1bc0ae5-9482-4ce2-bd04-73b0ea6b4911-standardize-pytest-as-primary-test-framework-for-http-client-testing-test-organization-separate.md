...
1. SHOULD: Test organization SHOULD separate unit tests (test/*.py) from integration tests (test/with_dummyserver/*.py)

## Policy Block

- SHOULD Test organization SHOULD separate unit tests (test/*.py) from integration tests (test/with_dummyserver/*.py)
