...
1. SHOULD: Dual-stack binding SHOULD reuse the same port number across IPv4 and IPv6 addresses

## Policy Block

- SHOULD Dual-stack binding SHOULD reuse the same port number across IPv4 and IPv6 addresses
