...
1. MUST: Exception testing MUST use pytest.raises() context manager rather than try-except blocks

## Policy Block

- MUST Exception testing MUST use pytest.raises() context manager rather than try-except blocks
