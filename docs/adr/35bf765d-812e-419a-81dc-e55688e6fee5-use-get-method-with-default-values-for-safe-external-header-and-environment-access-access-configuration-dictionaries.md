...
1. SHOULD: Access to configuration dictionaries and lookup tables (port_by_scheme, HASHFUNC_MAP, _SSL_VERSION_TO_TLS_VERSION) SHOULD use .get() with fallback values

## Policy Block

- SHOULD Access to configuration dictionaries and lookup tables (port_by_scheme, HASHFUNC_MAP, _SSL_VERSION_TO_TLS_VERSION) SHOULD use .get() with fallback values
