...
1. MUST: Production code MUST use .get() method with appropriate defaults when accessing response headers from external clients

## Policy Block

- MUST Production code MUST use .get() method with appropriate defaults when accessing response headers from external clients
