...
1. MUST: TLS test servers MUST use trustme CA for certificate generation with both SAN and non-SAN certificate variants

## Policy Block

- MUST TLS test servers MUST use trustme CA for certificate generation with both SAN and non-SAN certificate variants
