...
1. MUST: Test fixtures MUST be defined using @pytest.fixture decorator and shared fixtures MUST be placed in conftest.py

## Policy Block

- MUST Test fixtures MUST be defined using @pytest.fixture decorator and shared fixtures MUST be placed in conftest.py
