...
1. MUST: Each Python module MUST initialize its logger using logging.getLogger(__name__) at module level

## Policy Block

- MUST Each Python module MUST initialize its logger using logging.getLogger(__name__) at module level
