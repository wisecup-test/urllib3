...
1. MUST: Send implementations MUST preserve byte encoding semantics, converting string data to UTF-8 bytes when necessary before transmission

## Policy Block

- MUST Send implementations MUST preserve byte encoding semantics, converting string data to UTF-8 bytes when necessary before transmission
