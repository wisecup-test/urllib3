...
1. MUST: IPv6 tests MUST skip execution when HAS_IPV6 flag is false using pytest.skip()

## Policy Block

- MUST IPv6 tests MUST skip execution when HAS_IPV6 flag is false using pytest.skip()
